...
import * as HttpClient from "src/lib/httpService";
...
export class RoleServiceProxy {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<ListResultDtoOfPermissionDto>>(
  ...
  ): Observable<ListResultDtoOfPermissionDto> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? ListResultDtoOfPermissionDto.fromJS(resultData200)
            : new ListResultDtoOfPermissionDto();
          return _observableOf(result200);
        })
      );
    } else if (status === 401) {
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? GetRoleForEditOutput.fromJS(resultData200)
            : new GetRoleForEditOutput();
          return _observableOf(result200);
        })
      );
    } else if (status === 401) {
  ...
  ): Observable<PagedResultDtoOfRoleDto> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<PagedResultDtoOfRoleDto>>(
                (<any>_observableThrow(e))
              );
            }
          } else
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? PagedResultDtoOfRoleDto.fromJS(resultData200)
            : new PagedResultDtoOfRoleDto();
          return _observableOf(result200);
        })
      );
    } else if (status === 401) {
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? GetCurrentLoginInformationsOutput.fromJS(resultData200)
            : new GetCurrentLoginInformationsOutput();
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
...
export class TenantServiceProxy {
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? TenantDto.fromJS(resultData200)
            : new TenantDto();
          return _observableOf(result200);
        })
      );
  ...
  getAll(
    skipCount: number | null | undefined,
    maxResultCount: number | null | undefined
  ): Observable<PagedResultDtoOfTenantDto> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<PagedResultDtoOfTenantDto>>(
                (<any>_observableThrow(e))
              );
            }
          } else
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? PagedResultDtoOfTenantDto.fromJS(resultData200)
            : new PagedResultDtoOfTenantDto();
          return _observableOf(result200);
        })
      );
    } else if (status === 401) {
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? AuthenticateResultModel.fromJS(resultData200)
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processGetExternalAuthenticationProviders(<any>(
                response_
              ));
            } catch (e) {
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? ExternalAuthenticateResultModel.fromJS(resultData200)
            : new ExternalAuthenticateResultModel();
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
...
export class UserServiceProxy {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<ListResultDtoOfRoleDto>>(
                (<any>_observableThrow(e))
              );
            }
          } else
  ...
  protected processGetRoles(
    response: HttpResponseBase
  ): Observable<ListResultDtoOfRoleDto> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? ListResultDtoOfRoleDto.fromJS(resultData200)
            : new ListResultDtoOfRoleDto();
          return _observableOf(result200);
        })
      );
    } else if (status === 401) {
  ...
  getAll(
    skipCount: number | null | undefined,
    maxResultCount: number | null | undefined
  ): Observable<PagedResultDtoOfUserDto> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<PagedResultDtoOfUserDto>>(
                (<any>_observableThrow(e))
              );
            }
          } else
        ...
        _observableMergeMap(_responseText => {
          ...
          let resultData200 =
            _responseText === ""
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = resultData200
            ? PagedResultDtoOfUserDto.fromJS(resultData200)
            : new PagedResultDtoOfUserDto();
          return _observableOf(result200);
        })
      );
    } else if (status === 401) {
...
export class GetRoleForEditOutput implements IGetRoleForEditOutput {
  ...
  init(data?: any) {
    if (data) {
      ...
      if (
        ...
        data["grantedPermissionNames"].constructor === Array
      ) {
  ...
  toJSON(data?: any) {
    ...
    if (
      this.grantedPermissionNames &&
      this.grantedPermissionNames.constructor === Array
    ) {
      data["grantedPermissionNames"] = [];
